...
void MystestSetLstInt(uint & testnum, uint & testerr) {
  ...
  void MystestSetLstFloat(uint & testnum, uint & testerr) {
    uint loctestnum = 0, loctesterr = 0;
  ...
  void MystestSetLstString(uint & testnum, uint & testerr) {
    uint loctestnum = 0, loctesterr = 0;
...
void MystestSetVecInt(uint & testnum, uint & testerr) {
  uint loctestnum = 0, loctesterr = 0;
...
void MystestSetVecFloat(uint & testnum, uint & testerr) {
    uint loctestnum = 0, loctesterr = 0;
...
void MystestSetVecString(uint & testnum, uint & testerr) {
    uint loctestnum = 0, loctesterr = 0;
...
void MytestSimpleExercise1B(unsigned int & testCount, unsigned int & errorCount) {
    std::cout << std::endl << "Begin of TEST EXERCISE B:" << std::endl;
  
    MystestSetLstInt(testCount, errorCount);
    MystestSetLstString(testCount, errorCount);
    MystestSetLstFloat(testCount, errorCount);
    MystestSetVecInt(testCount,errorCount);
    MystestSetVecFloat(testCount,errorCount);
    MystestSetVecString(testCount,errorCount);
