...
void MytestSimpleExercise1A(unsigned int & testCount, unsigned int & errorCount) {
  ...
  MystestVectorInt(testCount, errorCount);
  MystestVectorDouble(testCount, errorCount);
  MystestVectorString(testCount, errorCount);
  MystestListInt(testCount, errorCount);
  MystestListDouble(testCount, errorCount);
  MystestListString(testCount, errorCount);
