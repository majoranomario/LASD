...
void TestPQHeapInt(uint & testnum, uint & testerr) {
    ...
    try {
        ...
        Change(loctestnum, loctesterr, pq, 0, 1);
        Tip(loctestnum, loctesterr, pq, true, 40);

        // Change leaf to larger value
        Change(loctestnum, loctesterr, pq, pq.Size()-1, 50);
        Tip(loctestnum, loctesterr, pq, true, 50);

        // Change middle element
        Change(loctestnum, loctesterr, pq, 3, 60);
        ...
        for(ulong i = 0; i < changePQ.Size(); i += 2) {
            Change(loctestnum, loctesterr, changePQ, i, static_cast<int>(100 + i));
        }
        ...
        for(int cycle = 0; cycle < 5; cycle++) {
            ...
            for(ulong i = 0; i < min((ulong)3, repeatPQ.Size()); i++) {
                Change(loctestnum, loctesterr, repeatPQ, i, rand() % 200);
            }
        }
...
void TestPQHeapDouble(uint & testnum, uint & testerr) {
    ...
    try {
        ...
        Change(loctestnum, loctesterr, pq, 0, 4.0);
        Tip(loctestnum, loctesterr, pq, true, 4.0);

        Change(loctestnum, loctesterr, pq, 1, 0.5);
        Tip(loctestnum, loctesterr, pq, true, 4.0);
        ...
        for(int j = 0; j < 10; j++) {
            ...
            if(repeatPQ.Size() > 0) {
                Change(loctestnum, loctesterr, repeatPQ, 0, (rand() % 200) / 10.0);
            }
        }
...
void TestPQHeapString(uint & testnum, uint & testerr) {
    ...
    try {
        ...
        Change(loctestnum, loctesterr, pq, 0, string("ZZZ"));
        Tip(loctestnum, loctesterr, pq, true, string("ZZZ"));

        Change(loctestnum, loctesterr, pq, 1, string("AAA"));
        Tip(loctestnum, loctesterr, pq, true, string("ZZZ"));
        ...
        Change(loctestnum, loctesterr, mixedPQ, 2, string("VeryHigh"));
